...
CREATE TABLE IF NOT EXISTS `npwd_twitter_profiles` (
    ...
    << << << < HEAD `identifier` varchar(48) NOT NULL,
    ...
    `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    >> >> >> > 430fb220b1cf887c9cd69b76a30160a4b0684520 PRIMARY KEY (`id`),
    UNIQUE KEY `profile_name_UNIQUE` (`profile_name`),
    INDEX `identifier` (`identifier`)
);
<< << << < HEAD CREATE TABLE IF NOT EXISTS `npwd_phone_contacts` (
...
<< << << < HEAD CREATE TABLE IF NOT EXISTS `npwd_match_profiles` (
    `id` int NOT NULL AUTO_INCREMENT,
    `identifier` varchar(48) NOT NULL,
...
<< << << < HEAD CREATE TABLE IF NOT EXISTS `npwd_notes` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `identifier` varchar(48) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npwd_marketplace_listings` (
    ...
    `title` varchar(255) DEFAULT NULL,
    `url` varchar(255) DEFAULT NULL,
    >> >> >> > 430fb220b1cf887c9cd69b76a30160a4b0684520 `description` varchar(255) NOT NULL,
    `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
<< << << < HEAD CREATE TABLE IF NOT EXISTS `npwd_messages` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    == == == = CREATE TABLE IF NOT EXISTS `npwd_messages` (
        ...
        >> >> >> > 430fb220b1cf887c9cd69b76a30160a4b0684520 `conversation_id` varchar(512) NOT NULL,
...
<< << << < HEAD CREATE TABLE IF NOT EXISTS `npwd_calls` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `identifier` varchar(48) DEFAULT NULL,
